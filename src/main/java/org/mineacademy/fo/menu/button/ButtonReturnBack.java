...
public final class ButtonReturnBack extends Button {
	...
	@Getter
	@Setter
	private static CompMaterial material = CompMaterial.ARROW;
	...
	@Getter
	@Setter
	private static String title = "&AGo Back";
	...
	@Getter
	@Setter
	private static List<String> lore = Arrays.asList("", "To Previous Menu");
